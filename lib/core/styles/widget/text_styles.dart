...
InputDecoration searchDecoration(){
  return const InputDecoration(counterText: '',border: InputBorder.none, contentPadding: EdgeInsets.only(left: 30,top: 12),prefixIcon: Icon(Icons.search,color: Colors.white,),hintText: search, hintStyle: TextStyle(color: Colors.white, fontSize: 16, fontWeight: FontWeight.w500));
}